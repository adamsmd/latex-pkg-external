...
\begin{tcblisting}{}
\gauge\external[documentclass/options={12pt}]{M}\gauge
\end{tcblisting}
...
Corresponds to the pre-savebox argument of \cs{ExternalCode}
...
\begin{tcblisting}{}
\gauge\external[includegraphics/options={angle=45}]{M}\gauge
\end{tcblisting}
