...
%\begin{tcblisting}{}
%<\external{M\rlap{\rule[3pt]{2in}{1pt}}M}>
%
%<\external[margin/right=3in]{M\rlap{\rule[3pt]{2in}{1pt}}M}>
%\end{tcblisting}
%
%\begin{tcblisting}{}
%\begin{flushright}
%<\external{M\llap{\rule[3pt]{2in}{1pt}}M}>
%
%<\external[margin/left=3in]{M\llap{\rule[3pt]{2in}{1pt}}M}>
%\end{flushright}
%\end{tcblisting}
%
%\begin{tcblisting}{}
%\vspace{2in}
%<\external{M\smash{\rule{1pt}{2in}}M}>
%<\external[margin/top=3in]{M\smash{\rule{1pt}{2in}}M}>
%\end{tcblisting}
%
%\begin{tcblisting}{}
%<\external{M\smash{\rule[-2in]{1pt}{2in}}M}>
%<\external[margin/bottom=3in]{M\smash{\rule[-2in]{1pt}{2in}}M}>
%\vspace{2in}
%\end{tcblisting}
...
\begin{tcblisting}{}
<\ExternalCompile[file=example-standalone-simple]>
<\ExternalRead[file=example-standalone-simple]>
\end{tcblisting}
...
\begin{tcblisting}{}
<\ExternalCompile[file=example-standalone-catcode]>
<\ExternalRead[file=example-standalone-catcode]>
\end{tcblisting}
