...
%%\newexternalenv[]{}
%\makeatletter
%\NewEnviron{extenv}{\expandafter\external@externalflipped\expandafter{\BODY}{preamble={\usepackage{amsmath}},action={\stepcounter{external}}}}
%\makeatother
%
%%\NewEnviron{abcd}[1][]{\expandafter\external@externalflipped\expandafter{\BODY}{abcd}}}
%
%%\gauge\begin{extenv}[file=example-inline-new-\arabic{external}]$\iint xy\,dx\,dy$\end{extenv}\gauge
%
%\gauge
%\begin{extenv}
%$x\iint xy\,dx\,dy$
...
%\gauge
%\begin{extenv}{}
%$x\iiint xyz\,dx\,dy\,dz$
%\end{extenv}
%\gauge
%
%\begin{tcblisting}{}
%\newexternal[file=example-inline-new-\arabic{external},preamble={\usepackage{amsmath}},action={\stepcounter{external}}]{\extS}
%
