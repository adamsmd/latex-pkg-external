...
%%
%% This file contains the documentation for the `locpream` LaTeX package
%%
...
\begin{itemize}
\item Section~\ref{sec:Introduction}~(\nameref{sec:Introduction}) contains:
  \begin{itemize}
  \item an introduction to using this package~(Section~\ref{subsec:Quick Start}: \nameref{subsec:Quick Start}),
  \item an explanation of the notation used in this document~(Section~\ref{subsec:Notation}: \nameref{subsec:Notation}), and
  \item a comparison of this package to other, similar packages~(Section~\ref{subsec:Related Packages}: \nameref{subsec:Related Packages}).
  \end{itemize}

\item Section~\ref{sec:High-level Commands}~(\nameref{sec:High-level Commands}) contains
  documentation for the high-level commands and environments of this package, namely:
  \begin{itemize}
  \item \com{localpreamble},
  \item \env{localpreambleenv},
  \item \com{newlocalpreamble}, and
  \item \com{newlocalpreambleenv}.
  \end{itemize}

\item Section~\ref{sec:Low-level Commands}~(\nameref{sec:Low-level Commands}) contains
  documentation for the low-level commands of this package, namely,
  \begin{itemize}
  \item \com{LocalPreambleWrite},
  \item \com{LocalPreambleCompile},
  \item \com{LocalPreambleRead}, and
  \item \com{LocalPreambleCode}.
  \end{itemize}

\item Section~\ref{sec:Options}~(\nameref{sec:Options}) contains
  documentation for the options that can be passed to the commands and
  environments of this package.

\item Section~\ref{sec:Issues and Workarounds}~(\nameref{sec:Issues and Workarounds})
  contains common issues and how to fix or work around them.

\item Section~\ref{sec:Changelog}~(\nameref{sec:Changelog}) contains a
  list of the notable changes for each version of this package.
\end{itemize}
...
where white space around `|,|' and `|=|' is ignored.
...
command.
For example, if want to default to load the \pkg{amsmath} package, you
could use something like the following.

\begin{dispExample}
<\locpreamkeys{preamble={\usepackage{amsmath}}}>
<\localpreamble{$\iint xy\,dx\,dy$}>
<\locpreamkeys{preamble={}}>
\end{dispExample}
\end{docCommand}
...
\begin{docKey}{before}{=\meta{code}}{%
  initially |\cs{stepcounter}\{locpream@number\}|}\end{docKey}
...
\begin{docKey}{file}{=\meta{basename}}{%
  initially |\cs{jobname}-locpream-%
             \cs{arabic}\{locpream@number\}|}

This option is used by the default values of \key{file/tex file},
\key{file/dim file}, and \key{file/out file} to specify the basename of
the intermediate files that are generated.
...
%%%%%%%%%%
\begin{docKey}{file/tex extension}{=\meta{extension}}{initially |.tex|}\end{docKey}
\begin{docKey}{file/dim extension}{=\meta{extension}}{initially |.dim|}\end{docKey}
\begin{docKey}{file/out extension}{=\meta{extension}}{initially |.pdf|}

These options are used by the default values of \key{file/tex file},
\key{file/dim file}, and \key{file/out file} to specify the filename
extensions of the intermediate \LaTeX, dimension, and compiled files,
respectively.
...
\begin{docKey}{file/tex file}{=\meta{filename}}{initially\\|\cs{locpream@file}\cs{csname} locpream@file/tex extension\cs{endcsname}|}\end{docKey}
\begin{docKey}{file/dim file}{=\meta{filename}}{initially\\|\cs{locpream@file}\cs{csname} locpream@file/dim extension\cs{endcsname}|}\end{docKey}
\begin{docKey}{file/out file}{=\meta{filename}}{initially\\|\cs{locpream@file}\cs{csname} locpream@file/out extension\cs{endcsname}|}

These options specify the filenames of the intermediate \LaTeX,
dimension, and compiled files, respectively.
The default values for these concatenate \key{file} with \key{file/tex
  extension}, \key{file/dim extension}, and \key{file/out extension},
respectively.

These options are rarely needed.
For most uses, it is better to use \key{file}.
