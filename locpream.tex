...
\textbf{Section \ref{sec:Introduction}: \nameref{sec:Introduction}.}
Contains an introduction to using this package%
~(Section~\ref{subsec:Quick Start}: \nameref{subsec:Quick Start}),
an explanation of the notation used in this document%
~(Section~\ref{subsec:Notation}: \nameref{subsec:Notation}),
and a comparison of this package to other, similar packages%
~(Section~\ref{subsec:Related Packages}: \nameref{subsec:Related Packages}).

\textbf{Section \ref{sec:High-level Commands}: \nameref{sec:High-level Commands}.}
Contains documentation for the high-level commands and environments of
this package.

\textbf{Section \ref{sec:Low-level Commands}: \nameref{sec:Low-level Commands}.}
Contains documentation for the low-level commands of this package.

\textbf{Section \ref{sec:Options}: \nameref{sec:Options}.}
Contains documentation for the options that can be passed to the
commands and environments of this package.

\textbf{Section \ref{sec:Issues and Workarounds}: \nameref{sec:Issues and Workarounds}.}
Contains common issues and how to fix or work around them.

\textbf{Section \ref{sec:Changelog}: \nameref{sec:Changelog}.}
Contains a list of the notable changes in each version of this package.
\end{hangparas}
