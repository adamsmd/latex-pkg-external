...
TODO:~example and kerning
\begin{dispExample}
Test T\external{e}\external{s}t
\end{dispExample}
...
part of latex-preview (e.g. AUCTeX)
I do not understand very well
cannot set preamble
extracts but does not re-include
...
\Com{documentclass} and \Com{begin\{document\}}.
...
%%%%%%%%%%%%%%%%%%%%
\subsubsection{Listing and Displaying (TODO) Examples}
...
\paragraph{\pkg{standalone}} Finally, this package

sizing

TODO:~describe

minimal page (used internally)
